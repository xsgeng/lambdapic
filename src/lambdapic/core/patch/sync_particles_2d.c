...
PyObject* get_npart_to_extend_2d(PyObject* self, PyObject* args) {
    ...
    PyArrayObject *npart_patches_array = (PyArrayObject*) PyArray_ZEROS(1, &npatches, NPY_INT64, 0);
    ...
    npy_intp *npart_alive = (npy_intp*) PyArray_DATA(npart_patches_array);
    ...
    PyObject *ret = PyTuple_Pack(4, npart_to_extend_array, npart_incoming_array, npart_outgoing_array, npart_patches_array);
    return ret;
}
