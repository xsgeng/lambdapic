...
1. Copy/download the entire content of :download:`AI_prompt.md </AI_prompt.md>`
2. Paste it into your AI chatbot/agent as context
3. Example prompts:
